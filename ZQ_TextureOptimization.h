...
namespace ZQ
{
	...
	private:
		...
		float search_probe;
	public:
		void SetSource(const DImage& src);
	...
	ZQ_TextureOptimization::ZQ_TextureOptimization()
	{
		search_probe = 0.05;
	}
	...
	void ZQ_TextureOptimization::SetSource(const DImage& src)
	{
		data_src = src;
	}

	bool ZQ_TextureOptimization::SynthesisWithoutControl(const int border_width, const float reduce_factor, const int max_level, const float grad_weight,
		const int to_max_iter, const int sor_iter, DImage& output)
	{
	...
	bool ZQ_TextureOptimization::SynthesisWithControl(const DImage& ctrl, const int border_width, const float reduce_factor, const int max_level, const float grad_weight, const float ctrl_weight, 
		const int to_max_iter, const int sor_iter, DImage& output)
	{
	...
	void ZQ_TextureOptimization::_optimize_without_control_one_border_size(bool has_init_value, float *x, int border_width, int to_max_iter, int sor_iter, float grad_weight)
	{
		this->border_width = border_width;
	...
	void ZQ_TextureOptimization::_optimize_with_control_one_border_size(float *x, int border_width, int to_max_iter, int sor_iter, float grad_weight, float ctrl_weight)
	{
		this->border_width = border_width;
		int dst_width = data_dst.width();
		int dst_height = data_dst.height();
	...
	void ZQ_TextureOptimization::_select_xps(int dst_width, int dst_height, int border_width, int& num, ZQ_TextureOptimization::Neighbor* & xps)
	{
		int shift_x = 0;
		int shift_y = 0;
	...
	void ZQ_TextureOptimization::_randomNeighbor(int num, const ZQ_TextureOptimization::Neighbor* xps, ZQ_TextureOptimization::Neighbor *zps)
	{
	...
	void ZQ_TextureOptimization::_search_neighbor_without_control(int num, const ZQ_TextureOptimization::Neighbor *xps, const float* x, ZQ_TextureOptimization::Neighbor *zps)
	{
		int src_width = data_src.width();
		int src_height = data_src.height();
	...
	void ZQ_TextureOptimization::_search_neighbor_with_control(int num, const ZQ_TextureOptimization::Neighbor *xps, const float *x, float ctrl_weight, ZQ_TextureOptimization::Neighbor *zps)
	{
		int dst_width = data_dst.width();
		int dst_height = data_dst.height();
		int src_width = data_src.width();
	...
	void ZQ_TextureOptimization::_argmin_x_without_control(int num, const ZQ_TextureOptimization::Neighbor *xps, const ZQ_TextureOptimization::Neighbor *zps, 
		int sor_iter, float grad_weight, float *x)
	{
		int dst_width = data_dst.width();
		int dst_height = data_dst.height();
		int src_width = data_src.width();
	...
	void ZQ_TextureOptimization::_argmin_x_with_control(int num, const ZQ_TextureOptimization::Neighbor* xps, const ZQ_TextureOptimization::Neighbor* zps, 
		int sor_iter, float grad_weight, float ctrl_weight, float* x)
	{
		int dst_width = data_dst.width();
		int dst_height = data_dst.height();
		int src_width = data_src.width();
